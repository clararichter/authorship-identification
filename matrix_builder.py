...
import numpy as np
import pandas as pd
from feature_extraction import Text
...
class Matrix():
    ...
    def eliminate_sparse_columns(self, threshold):  # threshold -> min_percent_data
        ...
        columns_to_keep = ['original_book_author', 'word_length_avg', 'word_length_std_dev', 'sentence_length_avg',
                           'sentence_length_std_dev', 'word_richness']
...
if __name__ == '__main__':
    matrix = Matrix(
        ['mildred_a._wirt', 'oscar_wilde', 'mark_twain', 'elizabeth_gaskell', "george_eliot", "thomas_hardy",
         "robert_louis_stevenson", "arthur_conan_doyle", "edgar_rice_burroughs", "jack_london"])
